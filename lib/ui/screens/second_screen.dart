      ...
      child: ListView(
          ...
          children: <Widget>[
            ...
            LinkCard(
                ...
                url: Uri.parse(
                    'https://github.com/risfat/flutter_production_boilerplate_riverpod')),
            ...
            StaggeredGrid.count(
              ...
              children: <GridItem>[
                GridItem(
                  ...
                  url: Uri.parse('https://www.instagram.com/risfat404'),
                ),
                GridItem(
                  ...
                  url: Uri.parse(
                      'https://cpanel.devtech365.com/user/pay/Flutter%20Boilerplate'),
                ),
                GridItem(
                  title: 'website_card_title',
                  icon: FluentIcons.desktop_24_regular,
                  url: Uri.parse('https://www.devtech365.com'),
                ),
              ],
            ),
